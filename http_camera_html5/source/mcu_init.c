...
void RCC_Configuration(void)
{
 ...
 /* RCC system reset(for debug purpose) */
  ...
  /* TIM2 clock enable */
  RCC_APB1PeriphClockCmd(RCC_AHBPeriph_DMA1 | RCC_APB1Periph_TIM2 | RCC_APB1Periph_USART2 | RCC_APB1Periph_SPI2 | RCC_APB1Periph_UART4, ENABLE);
...
void NVIC_Configuration(void)
{
  ...
  //enable the UART4 global interrupt for camera
  /*
